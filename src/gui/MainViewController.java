...
public class MainViewController implements Initializable {
	...
	public void onMenuItemSellerAction() {
		loadView("/gui/SelllerList.fxml", (SellerListController controller) -> {
			controller.setSellerService(new SellerService());// aqui estou injetando o new DepartmentService() do método  setDepartmentService  da classe DepartmentListController

...
public class DepartmentListController implements Initializable {
	...
	private ObservableList<Department> obsList; // para pegar list essa classe é do javafx
	
	@FXML
	public void onBtNewAction(ActionEvent event) { //tratar o evento do botão
	...
	public void setDepartmentService(DepartmentService service) {
		this.service = service; //injeção de depencia  
	}
	...
	private void createDialogForm(Department obj, String absoluteName,Stage parentStage) {
		try {
			...
			dialogStage.initModality(Modality.WINDOW_MODAL);//Tela fica travada enquanto não fechar ela, não se fecha a anterior
